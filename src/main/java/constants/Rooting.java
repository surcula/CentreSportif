...
public class Rooting {
    public static final String TEMPLATE = "/views/template/template.jsp";
    ...
    public static final String SPORTFIELD_FORM_JSP = "/views/sportField-form.jsp";
    public static final String USER_FORM_JSP = "/views/user-form.jsp";
    public static final String SPORTFIELD_JSP = "/views/sportField.jsp";
}